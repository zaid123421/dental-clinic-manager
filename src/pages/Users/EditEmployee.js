...
export default function EditEmployee() {
    ...
    useEffect(() => {
      axios
        ...
        .then((data) => {
          ...
          setOriginalEmployee(data.data.data);
        })
        .catch((error) => {
          console.log(error);
        });
  ...
  // Functions
    ...
    async function EditEmployee() {
      ...
      try {
        await axios.post(`${BaseUrl}/employee/${employeeId}`, formData, {
          headers: {
            Accept: "application/json",
            Authorization: `Bearer ${token}`,
          },
        ...
        setModal({
          isOpen: true,
          message: "The Employee Has Been Edited Successfully !",
          image: successImage,
        });
        setTimeout(() => {
          nav(`/users`);
  ...
  const hasChanges =
    employee &&
    originalEmployee &&
    JSON.stringify(employee) !== JSON.stringify(originalEmployee);
    ...
    <>
      ...
      <div className="page-content p-3 md:py-5 md:p-5 bg-[#089bab1c]">
        ...
        <div className="flex items-center">
          ...
          />
          <Title className="flex-1" label="Edit Employee" />
        </div>
